...
typedef gboolean SlackAPIRawCallback(SlackAccount *sa, gpointer user_data, gpointer body, gsize size, const char *error);
...
void slack_api_raw_get(SlackAccount *sa, SlackAPIRawCallback *callback, gpointer user_data, const char *endpoint, /* const char *query_param1, const char *query_value1, */ ...) G_GNUC_NULL_TERMINATED;
